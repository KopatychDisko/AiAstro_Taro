...
```
Agent(
  prompt="Read /home/egor/projects/AiTaro/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/egor/projects/AiTaro/.cursor/gsd-core/templates/VALIDATION.md`
