...
INSTALL_JS_GLOBAL="/home/egor/projects/AiTaro/.cursor/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/egor/projects/AiTaro/.cursor/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
