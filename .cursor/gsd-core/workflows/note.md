...
- **Global scope**: `/home/egor/projects/AiTaro/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/egor/projects/AiTaro/.cursor/notes/`)
...
2. Glob `/home/egor/projects/AiTaro/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/home/egor/projects/AiTaro/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/egor/projects/AiTaro/.cursor/notes/` — works in any directory
