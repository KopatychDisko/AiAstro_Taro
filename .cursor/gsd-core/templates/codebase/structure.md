...
- Usage: Reference from command with `@/home/egor/projects/AiTaro/.cursor/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/egor/projects/AiTaro/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/egor/projects/AiTaro/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
